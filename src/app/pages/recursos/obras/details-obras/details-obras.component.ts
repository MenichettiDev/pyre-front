...
@Component({
  selector: 'app-details-obras',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './details-obras.component.html',
  styleUrls: ['./details-obras.component.css']
})
export class DetailsObrasComponent implements OnInit, AfterViewInit, OnDestroy {
  @Input() obraData: any | null = null;
